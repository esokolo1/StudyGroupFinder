...
let init = (app) => {
  ...
  app.computed = {
    ...
    is_valid_form: function () {
      return this.is_valid_date && this.name.length > 0 && this.loc.length > 0;
    },
  };
  ...
  app.methods = {
    ...
    submit_form: function () {
      console.log("inside submit_form");
  ...
  app.init = () => {
    axios.get(get_enrolled_courses_url).then((r) => {
      console.log("start_date in init:", this.start_date);
